...
namespace fullsail_ai { namespace fundamentals {
	...
	private:
		void preOrderHelper(void(*dataFunction)(Behavior const*), Behavior const * node)const;
	public:
	...
	private:
		void postOrderHelper(void(*dataFunction)(Behavior const*), Behavior const* node)const;
	public:
		//=======================================
